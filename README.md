...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-21 08:52`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a21d7a0e-38e8-4263-adfd-27bc2b1adfb6.git
$ cd a21d7a0e-38e8-4263-adfd-27bc2b1adfb6
```
